...
{
    [SerializeField] private Enums.WeaponActionType _type;
    ...
    public void UpdateUI(WeaponItem weaponItem)
    {
        ...
        if (_type == Enums.WeaponActionType.Active)
        {
            if (onCooldown)
            {
            ...
            else
            {
                ...
                _skillCost.text   = weaponItem.GetSkillCost(Enums.WeaponActionType.Active).ToString() + " SP";
        ...
        else
        {
            ...
            else
            {
                ...
                _skillCost.text   = weaponItem.GetSkillCost(Enums.WeaponActionType.Ultimate).ToString() + " SP";
