...
public class EnemyLocomotion : CharacterLocomotion
{
    ...
    public Tuple<float, float> RunAroundTarget()
    {
    ...
    public Tuple<float, float> RunTowardsTarget()
    {
    ...
    public Tuple<float, float> RunAwayFromTarget()
    {
        float verticalMovement = -1f;
        float horizontalMovement = SnapRunHorizontal(UnityEngine.Random.Range(-1, 1));
    ...
    public Tuple<float, float> WalkAroundTarget()
    {
        float verticalMovement = 0f;
    ...
    public Tuple<float, float> WalkTowardsTarget()
    {
    ...
    public Tuple<float, float> WalkAwayFromTarget()
    {
        float verticalMovement = -0.5f;
        float horizontalMovement = SnapWalkHorizontal(UnityEngine.Random.Range(-1, 1));
