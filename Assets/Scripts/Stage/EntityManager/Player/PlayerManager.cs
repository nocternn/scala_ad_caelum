...
public class PlayerManager : CharacterManager
{
    ...
    public void HandleAttack(Enums.WeaponActionType attack)
    {
        switch (attack)
        {
            case Enums.WeaponActionType.Basic:
                attacker.HandleBasicAttack();
                break;
            case Enums.WeaponActionType.Charged:
            ...
            case Enums.WeaponActionType.Ultimate:
                ...
                break;
            case Enums.WeaponActionType.Shoot:
                attacker.HandleShootAttack();
                break;
            case Enums.WeaponActionType.Combo:
